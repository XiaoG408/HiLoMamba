...
class LocalConv(nn.Module):
    def __init__(self, hidden_size, kernel_size, hidden_dropout_prob, hidden_act, layer_norm_eps):
        ...
        self.conv_1_3 = nn.Conv1d(in_channels=hidden_size, out_channels=hidden_size, kernel_size=kernel_size, stride=1, padding=self.padding)
    ...
    def forward(self, input_tensor):
        ...
        #hidden_states = input_tensor.permute(0, 2, 1)
